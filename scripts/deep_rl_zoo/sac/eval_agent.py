...
# ==============================================================================
"""Tests trained SAC (for Discrete Action) agent from checkpoint with a policy-greedy actor.
...
def main(argv):
    ...
    checkpoint = PyTorchCheckpoint(environment_name=FLAGS.environment_name, agent_name='SAC', restore_only=True)
