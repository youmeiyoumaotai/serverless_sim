...
# ==============================================================================
"""Tests trained IMPALA agent from checkpoint with a policy-greedy actor.
...
from deep_rl_zoo.networks.policy import ImpalaActorCriticMlpNet, ImpalaActorCriticConvNet
...
def main(argv):
    ...
    checkpoint = PyTorchCheckpoint(environment_name=FLAGS.environment_name, agent_name='IMPALA', restore_only=True)
    ...
    eval_agent = greedy_actors.ImpalaGreedyActor(
