...
# ==============================================================================
"""Tests trained Double DQN agent from checkpoint with a e-greedy actor.
...
from deep_rl_zoo.networks.value import DqnMlpNet, DqnConvNet
...
def main(argv):
    ...
    checkpoint = PyTorchCheckpoint(environment_name=FLAGS.environment_name, agent_name='Double-Q', restore_only=True)
