...
# ==============================================================================
"""Tests trained C51 DQN agent from checkpoint with a e-greedy actor.
...
from deep_rl_zoo.networks.value import C51DqnMlpNet, C51DqnConvNet
...
def main(argv):
    ...
    if FLAGS.environment_name in gym_env.CLASSIC_ENV_NAMES:
        ...
        action_dim = eval_env.action_space.n
        network = C51DqnConvNet(state_dim=state_dim, action_dim=action_dim, atoms=atoms)
    ...
    checkpoint = PyTorchCheckpoint(environment_name=FLAGS.environment_name, agent_name='C51-DQN', restore_only=True)
