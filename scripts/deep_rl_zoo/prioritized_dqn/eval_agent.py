...
# ==============================================================================
"""Tests trained Prioritized DQN agent from checkpoint with a e-greedy actor.
...
def main(argv):
    ...
    checkpoint = PyTorchCheckpoint(environment_name=FLAGS.environment_name, agent_name='PER-DQN', restore_only=True)
