...
# ==============================================================================
"""Tests trained PPO agent from checkpoint with a policy-greedy actor.
...
def main(argv):
    ...
    checkpoint = PyTorchCheckpoint(environment_name=FLAGS.environment_name, agent_name='PPO', restore_only=True)
