...
# ==============================================================================
"""Tests trained REINFORCE agent from checkpoint with a policy-greedy actor.
...
def main(argv):
    ...
    checkpoint = PyTorchCheckpoint(environment_name=FLAGS.environment_name, agent_name='REINFORCE', restore_only=True)
